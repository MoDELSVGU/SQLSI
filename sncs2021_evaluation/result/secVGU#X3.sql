...
DROP FUNCTION IF EXISTS auth_READ_Module_code;
/* FUNC: auth_READ_Module_code */
DELIMITER //
CREATE FUNCTION auth_READ_Module_code(_caller varchar(250), _role varchar(250), _self varchar(250))
RETURNS INT DETERMINISTIC
BEGIN
DECLARE result INT DEFAULT 0;
RETURN 0;
...
DROP FUNCTION IF EXISTS auth_READ_Contact;
/* FUNC: auth_READ_Contact */
DELIMITER //
CREATE FUNCTION auth_READ_Contact(_students varchar(250), _caller varchar(250), _role varchar(250), _lecturers varchar(250))
RETURNS INT DETERMINISTIC
BEGIN
DECLARE result INT DEFAULT 0;
RETURN 0;
