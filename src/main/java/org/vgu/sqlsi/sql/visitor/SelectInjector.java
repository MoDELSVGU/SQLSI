...
public class SelectInjector implements SelectVisitor {
  ...
  private Expression RepExp(
      Expression exp, Association association, Expression leftExp, Expression rightExp) {
  ...
  private List<SelectItem> SecExpList(List<SelectItem> selitems, FromItem fromItem)
      throws Exception {
