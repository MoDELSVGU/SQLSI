...
public class RepExpInjector implements ExpressionVisitor {
	...
	public void visit(AndExpression andExpression) {
		...
		AndExpression newAndExpression = new AndExpression(leftRepExpInjector.getResult(),
				rightRepExpInjector.getResult());
	...
	public void visit(Column tableColumn) {
		...
		if (columnName.equalsIgnoreCase(association.getLeftEnd().getOpp())) {
			this.setResult(getLeftExp());
		} else if (columnName.equalsIgnoreCase(association.getRightEnd().getOpp())) {
