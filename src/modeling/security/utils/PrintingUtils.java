...
import modeling.statements.VariableComparator;
...
public class PrintingUtils {
     ...
     */
    public static String getParametersWithType(ArrayList<Variable> variables) {
        String s = "";
...
//        Collections.sort(variables, new VariableComparator());
     ...
     */
    public static String getParameters(ArrayList<Variable> variables) {
        String s = "";
        int countPars = variables.size();
//        Collections.sort(variables, new VariableComparator());
        for (Variable v : variables) {
