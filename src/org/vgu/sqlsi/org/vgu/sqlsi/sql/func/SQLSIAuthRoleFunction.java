...
public class SQLSIAuthRoleFunction extends SQLFunction {
    ...
    public SQLSIAuthRoleFunction(String action, String resource, String role,
        List<String> ocl, List<String> sql) {
    ...
    public String getFunctionName() {
        return String.format("auth_%s_%s_%s", this.getAction(),
            this.getResource(), this.role);
    }
