...
public class SecExpInjector implements ExpressionVisitor {
    ...
    public void visit(GreaterThanEquals greaterThanEquals) {
        ...
        greaterThanEquals
            .setRightExpression(rightInjectorExpression.getResult());
    ...
    public void visit(Column column) {
        ...
        if (SQLSIUtils.isPrimaryKey(dataModel, columnName, tableName)) {
            ...
            try {
                SQLSIAuthFunction secFunction = SQLSIUtils
                    .findAuthFunctionAttribute(functions, columnName,
                        tableName);
            ...
            ExpressionList expList = new ExpressionList(Arrays.asList(
                new Column(String.format("%s%s", Configuration.PARAM_PREFIX,
        ...
        } else if (SQLSIUtils.isAssociationEnd(dataModel, tableName,
            columnName)) {
            CaseExpression siCase = new CaseExpression();
            Function function = new Function();
            // TODO: Implement this!
            try {
                SQLSIAuthFunction secFunction = SQLSIUtils
                    .findAuthFunctionAssociation(dataModel, functions,
            ...
            ExpressionList expList = new ExpressionList(Arrays.asList(
                new Column(String.format("%s%s", Configuration.PARAM_PREFIX,
                    Configuration.CALLER)),
                new Column(String.format("%s%s", Configuration.PARAM_PREFIX, Configuration.ROLE)),
